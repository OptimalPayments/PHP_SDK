<?php
    ...
    use OptimalPayments\CustomerVault\Mandates;
...
if ($_POST)
    {
        ...
        if (isset($_POST['paysafe']))
        {
            ...
            {
                $client = new OptimalApiClient($optimalApiKeyId, $optimalApiKeySecret, Environment::TEST, "1001057430");
            } else if ($accountCreation == "EFTcreate" || $accountCreation == "EFTlookup" || $accountCreation == "EFTupdate" || $accountCreation == "EFTdelete")
            {
                $client = new OptimalApiClient($optimalApiKeyId, $optimalApiKeySecret, Environment::TEST, '1001057670');
            } else if ($accountCreation == "BACScreate" || $accountCreation == "BACSlookup" || $accountCreation == "BACSupdate" || $accountCreation == "BACSdelete")
            {
                $client = new OptimalApiClient($optimalApiKeyId, $optimalApiKeySecret, Environment::TEST, '1001057660');
            } else if ($accountCreation == "SEPAcreate" || $accountCreation == "SEPAlookup" || $accountCreation == "SEPAupdate" || $accountCreation == "SEPAdelete")
            {
                $client = new OptimalApiClient($optimalApiKeyId, $optimalApiKeySecret, Environment::TEST, '1001057620');
            ...
            {
                $client = new OptimalApiClient($optimalApiKeyId, "B-qa2-0-54b5374e-302d02147911306b5c6db4ad74e083803733163195c75ef902150095b4a21a5ea7f4c19b7b37aed1944490b59e785e", Environment::TEST, '1001057620');
            ...
            {
                $client = new OptimalApiClient($optimalApiKeyId, "B-qa2-0-54b5374e-302d02147911306b5c6db4ad74e083803733163195c75ef902150095b4a21a5ea7f4c19b7b37aed1944490b59e785e", Environment::TEST, '1001057660');
            } else
            {
        ...
        try
        {
            if ($accountCreation == "ACHcreate")
            {
                ...
                $bankAccount = $client->customerVaultService()->createACHBankAccount(new OptimalPayments\CustomerVault\ACHBankaccounts(array(
            ...
            {
                $bankAccount = $client->customerVaultService()->getACHBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\ACHBankaccounts(array(
            ...
            {
                $bankAccount = $client->customerVaultService()->updateACHBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid'])), new OptimalPayments\CustomerVault\ACHBankaccounts(array(
                    'id' => $_POST['bankAccountId'],
            ...
            {
                $bankAccount = $client->customerVaultService()->deleteACHBankAccount(new OptimalPayments\CustomerVault\Profile(array('id' => $_POST['profileid']))
                        , new OptimalPayments\CustomerVault\ACHBankaccounts(array(
                    'id' => $_POST['bankAccountId'])));
            ...
            } else if ($accountCreation == "EFTcreate")
            {
                ...
                $bankAccount = $client->customerVaultService()->createEFTBankAccount(new OptimalPayments\CustomerVault\EFTBankaccounts(array(
            ...
            {
                $bankAccount = $client->customerVaultService()->getEFTBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\EFTBankaccounts(array(
                    'id' => $_POST['bankAccountId']
                )));
            ...
            {
                $bankAccount = $client->customerVaultService()->updateEFTBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid'])), new OptimalPayments\CustomerVault\EFTBankaccounts(array(
                    'id' => $_POST['bankAccountId'],
                    'transitNumber' => "25039",
                    'institutionId' => "003",
                    'accountHolderName' => $_POST['accountHolderName'],
            ...
            {
                $bankAccount = $client->customerVaultService()->deleteEFTBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\EFTBankaccounts(array(
                    'id' => $_POST['bankAccountId']
            ...
            } else if ($accountCreation == "BACScreate")
            {
                ...
                $bankAccount = $client->customerVaultService()->createBACSBankAccount(new OptimalPayments\CustomerVault\BACSBankaccounts(array(
                    'id' => $profile->id,
                    'accountNumber' => rand(0, 999999999), //'988234423',
            ...
            } else if ($accountCreation == "BACSlookup")
            {
                ...
                $bankAccount = $client->customerVaultService()->getBACSBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\BACSBankaccounts(array(
                    'id' => $_POST['bankAccountId']
                )));
            ...
            {
                $bankAccount = $client->customerVaultService()->updateBACSBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid'])), new OptimalPayments\CustomerVault\BACSBankaccounts(array(
                    'id' => $_POST['bankAccountId'],
                    'accountHolderName' => $_POST['accountHolderName'],
            ...
            {
                $bankAccount = $client->customerVaultService()->deleteBACSBankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\BACSBankaccounts(array(
                    'id' => $_POST['bankAccountId']
            ...
            } else if ($accountCreation == "SEPAcreate")
            {
                ...
                $bankAccount = $client->customerVaultService()->createSEPABankAccount(new OptimalPayments\CustomerVault\SEPABankaccounts(array(
                    'id' => $profile->id, //$_POST['profileid'], //$profile->id,
                    'iban' => $_POST['iban'],
                    'accountHolderName' => $_POST['first_name'],
                    'billingAddressId' => $address->id
            ...
            {
                $bankAccount = $client->customerVaultService()->getSEPABankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\SEPABankaccounts(array(
                    'id' => $_POST['bankAccountId']
                )));
            ...
            {
                $bankAccount = $client->customerVaultService()->updateSEPABankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid'])), new OptimalPayments\CustomerVault\SEPABankaccounts(array(
                    'id' => $_POST['bankAccountId'],
                    'accountHolderName' => $_POST['accountHolderName'],
                    'iban' => $_POST['iban'],
                    'billingAddressId' => $_POST['billingAddressId'],
            ...
            {
                $bankAccount = $client->customerVaultService()->deleteSEPABankAccount(new OptimalPayments\CustomerVault\Profile(array(
                    'id' => $_POST['profileid']
                        ))
                        , new OptimalPayments\CustomerVault\SEPABankaccounts(array(
                    'id' => $_POST['bankAccountId']
